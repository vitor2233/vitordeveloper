    ...
    return (
        <div className={styles.profile}>
            ...
            <main className={styles.profileInformation}>
                ...
                <div>
                    <p className={styles.description}>Desenvolvedor backend com +3 anos de experiência em C# e Angular. Também possuo habilidades em Node.js e Flutter, permitindo-me criar soluções robustas e eficientes tanto para web quanto para dispositivos móveis. Sou apaixonado por resolver desafios complexos e estou sempre buscando aprender e me aprimorar. </p>
                </div>
